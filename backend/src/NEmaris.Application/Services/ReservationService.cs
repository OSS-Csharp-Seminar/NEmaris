...
public class ReservationService : IReservationService
{
    ...
    public async Task<IReadOnlyList<AvailableTableDto>> GetAvailableTablesAsync(GetAvailableTablesQueryDto query)
    {
        ...
        var applyLiveStatus = query.StartTime <= DateTime.UtcNow + RestaurantPolicies.LiveStatusWindow;
        var tables = await _reservationRepository.GetAvailableTablesAsync(query.StartTime, query.EndTime, query.PartySize, applyLiveStatus, query.ExcludeReservationId);
        return tables
