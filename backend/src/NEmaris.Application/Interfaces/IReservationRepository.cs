...
public interface IReservationRepository
{
    ...
    Task<IReadOnlyList<RestaurantTables>> GetAvailableTablesAsync(DateTime startTime, DateTime endTime, int partySize, bool applyLiveStatus, long? excludeReservationId = null);
